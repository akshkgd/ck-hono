  ...
  <header class="sticky top-0 z-50 w-full border-b border-zinc-900 bg-zinc-950/80 backdrop-blur">
    <div class="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
      ...
      <div class="flex items-center space-x-6">
        ...
        <span class="text-xs font-mono text-zinc-500">API Version: 1.4.0</span>
      </div>
    </div>
  </header>
  ...
  <main class="flex-grow max-w-5xl w-full mx-auto px-6 py-12">
    ...
    <div class="mb-16 text-center max-w-2xl mx-auto">
      <div class="inline-flex items-center space-x-1.5 px-3 py-1 rounded-full bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 text-xs font-semibold mb-4 tracking-wide uppercase">
        ...
        <span>Latest Update: July 17, 2026</span>
      </div>
    ...
    <div class="relative border-l border-zinc-800 ml-4 md:ml-32 space-y-16">
      ...
      <div class="relative pl-8 group mb-12">
        ...
        <div class="hidden md:block absolute -left-36 top-1 text-right w-28">
          <span class="text-xs font-mono text-indigo-400 font-semibold block">v1.4.0</span>
          <span class="text-[10px] font-mono text-zinc-500 block">July 17, 2026</span>
        </div>

        <!-- Mobile Date/Version Info -->
        <div class="md:hidden flex items-center space-x-2 mb-2 font-mono text-xs">
          <span class="text-indigo-400 font-semibold">v1.4.0</span>
          <span class="text-zinc-600">•</span>
          <span class="text-zinc-500">July 17, 2026</span>
        </div>
        ...
        <div class="bg-zinc-900/40 border border-zinc-900 rounded-xl p-6 md:p-8 hover:border-zinc-800 transition shadow-sm">
          <h2 class="text-lg font-semibold text-zinc-50 mb-2 flex items-center gap-3">
            <span>Sequential Learning & Homework Gates</span>
          ...
          <p class="text-xs text-zinc-400 mb-6 leading-relaxed">
            Introduced support for linear/sequential learning configurations on a per-enrollment basis. Students can now be restricted from opening upcoming chapters until they complete preceding material. Further added a homework-gate setting requiring successful assignment uploads before next classes unlock.
          </p>
          ...
          <div class="space-y-3 font-mono text-xs">
            <div class="bg-zinc-950/60 border border-zinc-900 rounded-lg p-3 flex flex-wrap items-center justify-between gap-3">
              <div class="flex items-center gap-3">
                ...
                <span class="text-zinc-200 font-semibold">/v1/student/courses/:batchId</span>
              </div>
              <a href="/student-docs#endpoint-student-course-details" class="text-[10px] text-indigo-400 hover:text-indigo-300 font-medium transition">View Docs →</a>
            </div>
          </div>
        </div>
      </div>

      <!-- Release Entry: v1.3.0 -->
      <div class="relative pl-8 group mb-12">
        <!-- Badge Indicator on Timeline -->
        <span class="absolute -left-[9px] top-1 flex h-4 w-4 items-center justify-center rounded-full bg-indigo-600 ring-4 ring-zinc-950 shadow-md">
          <svg class="h-2 w-2 text-zinc-50" fill="currentColor" viewBox="0 0 8 8"><circle cx="4" cy="4" r="3"/></svg>
        ...
        <!-- Floating Date Left on Desktop -->
        <div class="hidden md:block absolute -left-36 top-1 text-right w-28">
          <span class="text-xs font-mono text-indigo-400 font-semibold block">v1.3.0</span>
          <span class="text-[10px] font-mono text-zinc-500 block">July 15, 2026</span>
        </div>

        <!-- Mobile Date/Version Info -->
        <div class="md:hidden flex items-center space-x-2 mb-2 font-mono text-xs">
          <span class="text-indigo-400 font-semibold">v1.3.0</span>
          <span class="text-zinc-600">•</span>
          <span class="text-zinc-500">July 15, 2026</span>
        </div>

        <!-- Release Card -->
        <div class="bg-zinc-900/40 border border-zinc-900 rounded-xl p-6 md:p-8 hover:border-zinc-800 transition shadow-sm">
          <h2 class="text-lg font-semibold text-zinc-50 mb-2 flex items-center gap-3">
            <span>Student Profiles & Admin Cohort Progress Tracking</span>
            <span class="text-[10px] font-mono px-2 py-0.5 rounded-full bg-emerald-500/10 text-emerald-400 border border-emerald-500/20">LIVE</span>
          </h2>
          <p class="text-xs text-zinc-400 mb-6 leading-relaxed">
          ...
          <div class="space-y-3 font-mono text-xs">
            <div class="bg-zinc-950/60 border border-zinc-900 rounded-lg p-3 flex flex-wrap items-center justify-between gap-3">
              <div class="flex items-center gap-3">
                <span class="text-[10px] font-bold px-2 py-0.5 rounded bg-blue-500/10 text-blue-400 border border-blue-500/20">PUT</span>
                <span class="text-zinc-200 font-semibold">/v1/student/profile</span>
              </div>
              <a href="/student-docs#student-update-profile" class="text-[10px] text-indigo-400 hover:text-indigo-300 font-medium transition">View Docs →</a>
            </div>
            <div class="bg-zinc-950/60 border border-zinc-900 rounded-lg p-3 flex flex-wrap items-center justify-between gap-3">
              <div class="flex items-center gap-3">
                <span class="text-[10px] font-bold px-2 py-0.5 rounded bg-green-500/10 text-green-400 border border-green-500/20">GET</span>
            ...
            <div class="bg-zinc-950/60 border border-zinc-900 rounded-lg p-3 flex flex-wrap items-center justify-between gap-3">
              <div class="flex items-center gap-3">
                <span class="text-[10px] font-bold px-2 py-0.5 rounded bg-green-500/10 text-green-400 border border-green-500/20">GET</span>
                <span class="text-zinc-200 font-semibold">/v1/admin/assignments/enrollments/:enrollmentId</span>
              </div>
      ...
      <div class="relative pl-8 group mb-12">
        ...
        <div class="bg-zinc-900/40 border border-zinc-900 rounded-xl p-6 md:p-8 hover:border-zinc-800 transition shadow-sm">
          ...
          <p class="text-xs text-zinc-400 mb-6 leading-relaxed">
            Released student dashboard API endpoints for course details, access controls, progress heartbeats, and assignment submissions. Added a dedicated administrator assignments grading dashboard with chronological graph chart analytics and composite database indexing. Updated the content library schema and CRUD operations to support the new nullable <code class="font-mono text-zinc-200">videoDuration</code>, <code class="font-mono text-zinc-200">assignment</code>, and <code class="font-mono text-zinc-200">xp</code> fields. Introduced <code class="font-mono text-zinc-200">canSubmitAssignment</code> control flags on batch content associations to toggle assignment submissions on a per-chapter basis, and exposed them inside the student course details API responses.
          </p>
