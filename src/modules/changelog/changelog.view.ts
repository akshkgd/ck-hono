      ...
      <div class="relative pl-8 group mb-12">
        ...
        <div class="bg-zinc-900/40 border border-zinc-900 rounded-xl p-6 md:p-8 hover:border-zinc-800 transition shadow-sm">
          ...
          <p class="text-xs text-zinc-400 mb-6 leading-relaxed">
            Released student dashboard API endpoints for course details, access controls, progress heartbeats, and assignment submissions. Added a dedicated administrator assignments grading dashboard with chronological graph chart analytics and composite database indexing. Updated the content library schema and CRUD operations to support the new nullable <code class="font-mono text-zinc-200">videoDuration</code> and <code class="font-mono text-zinc-200">assignment</code> fields. Introduced <code class="font-mono text-zinc-200">canSubmitAssignment</code> control flags on batch content associations to toggle assignment submissions on a per-chapter basis.
          </p>
