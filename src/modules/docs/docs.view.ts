      ...
      <nav class="space-y-6">
        ...
        <div>
          ...
          <ul class="space-y-1.5 pl-2 border-l border-zinc-900 ml-1">
            <li class="flex items-center gap-2">
              <span class="text-[8px] font-bold px-1 rounded bg-green-500/10 text-green-400 font-mono">GET</span>
              <a href="#live-sessions-list" class="block py-1 text-xs text-zinc-400 hover:text-indigo-400 transition font-mono truncate">List all sessions</a>
            </li>
            <li class="flex items-center gap-2">
              <span class="text-[8px] font-bold px-1 rounded bg-green-500/10 text-green-400 font-mono">GET</span>
              <a href="#batch-live-sessions-list" class="block py-1 text-xs text-zinc-400 hover:text-indigo-400 transition font-mono truncate">List batch sessions</a>
            </li>
            <li class="flex items-center gap-2">
              <span class="text-[8px] font-bold px-1 rounded bg-blue-500/10 text-blue-400 font-mono">POST</span>
...
export interface Batch {
  ...
  logo: string | null;
  type: 'cohort' | 'live' | 'webinar' | 'callBooking' | 'mentorship' | 'recorded'; // Default: 'cohort'
  startDate: string;
  endDate: string;
...
const data = await response.json();</code></pre>
            ...
            <div class="space-y-2 pt-4">
              ...
              <table class="w-full text-xs font-mono border-collapse border border-zinc-900 text-left">
                ...
                <tbody>
                  ...
                  <tr class="border-b border-zinc-900"><td class="p-2 border-r border-zinc-900 text-zinc-300">type</td><td class="p-2 border-r border-zinc-900 text-zinc-400">enum</td><td class="p-2 text-zinc-400">'cohort' | 'live' | 'webinar' | 'callBooking' | 'mentorship' | 'recorded'</td></tr>
              ...
              <div class="max-h-[300px] overflow-y-auto border border-zinc-900 rounded-lg custom-scrollbar">
                <table class="w-full text-xs border-collapse text-left font-normal">
                  ...
                  <tbody>
                    ...
                    <tr class="border-b border-zinc-900"><td class="p-2 border-r border-zinc-900 font-mono text-zinc-300">type</td><td class="p-2 border-r border-zinc-900 text-zinc-400">enum</td><td class="p-2 border-r border-zinc-900 text-zinc-500">No</td><td class="p-2 text-zinc-400">'cohort' | 'live' | 'webinar' | 'callBooking' | 'mentorship' | 'recorded' (Default 'cohort')</td></tr>
                    <tr class="border-b border-zinc-900"><td class="p-2 border-r border-zinc-900 font-mono text-zinc-300">whatsAppLink</td><td class="p-2 border-r border-zinc-900 text-zinc-400">string</td><td class="p-2 border-r border-zinc-900 text-zinc-500">No</td><td class="p-2 text-WhatsApp invite link.</td></tr>
          ...
          <div class="xl:col-span-3 space-y-4">
            ...
            <div class="space-y-2 pt-4">
              ...
              <table class="w-full text-xs font-mono border-collapse border border-zinc-900 text-left font-normal">
                ...
                <tbody>
                  <tr class="border-b border-zinc-900"><td class="p-2 border-r border-zinc-900 text-zinc-300">q</td><td class="p-2 border-r border-zinc-900 text-zinc-400">string</td><td class="p-2 border-r border-zinc-900 text-zinc-500">""</td><td class="p-2 text-zinc-400">Keyword filter matching title.</td></tr>
                  <tr class="border-b border-zinc-900"><td class="p-2 border-r border-zinc-900 text-zinc-300">batchId</td><td class="p-2 border-r border-zinc-900 text-zinc-400">string</td><td class="p-2 border-r border-zinc-900 text-zinc-500">-</td><td class="p-2 text-zinc-400">UUID of the batch.</td></tr>
                  <tr class="border-b border-zinc-900"><td class="p-2 border-r border-zinc-900 text-zinc-300">limit</td><td class="p-2 border-r border-zinc-900 text-zinc-400">number</td><td class="p-2 border-r border-zinc-900 text-zinc-500">50</td><td class="p-2 text-zinc-400">Max page size (1 to 100).</td></tr>
            ...
            <div class="space-y-2 pt-4">
              ...
              <table class="w-full text-xs font-mono border-collapse border border-zinc-900 text-left font-normal font-sans">
                ...
                <tbody>
                  ...
                  <tr class="border-b border-zinc-900"><td class="p-2 border-r border-zinc-900 text-zinc-300">limit</td><td class="p-2 border-r border-zinc-900 text-zinc-400">number</td><td class="p-2 border-r border-zinc-900 text-zinc-500">100</td><td class="p-2 text-zinc-400">Max page size (1 to 200).</td></tr>
                  <tr class="border-b border-zinc-900"><td class="p-2 border-r border-zinc-900 text-zinc-300">page</td><td class="p-2 border-r border-zinc-900 text-zinc-400">number</td><td class="p-2 border-r border-zinc-900 text-zinc-500">1</td><td class="p-2 text-zinc-400">Offset pagination page multiplier.</td></tr>
                </tbody>
              </table>
            </div>
  ...
  "data": {
    ...
    "videoLink": "https://vz-09b5be34-aef.b-cdn.net/143aeeff-e353-4b64-8a8c-204d777bdbcc/playlist.m3u8",
    "signedUrl": "https://vz-09b5be34-aef.b-cdn.net/bcdn_token=HS256-HASH&expires=1724000000&token_path=%2F143aeeff-e353-4b64-8a8c-204d777bdbcc%2F/143aeeff-e353-4b64-8a8c-204d777bdbcc/playlist.m3u8",
  ...
  headers: {
    'Authorization': 'Bearer eyJhbGciOiJIUzI1Ni...'
        ...
        <div id="batch-live-sessions-list" class="scroll-mt-24 grid grid-cols-1 xl:grid-cols-5 gap-8">
          <div class="xl:col-span-3 space-y-4">
            <div class="text-xs text-indigo-400 font-mono tracking-wider font-semibold uppercase">Admin: Live Sessions</div>
            <h3 class="text-2xl font-semibold text-zinc-100">List batch live sessions</h3>
            <p class="text-zinc-400 text-sm leading-relaxed">
              Fetches all scheduled live sessions for a specific batch with optional <code class="text-indigo-400 font-mono">sectionId</code> filtering. Requires Admin Role.
            </p>
            <div class="flex items-center gap-2 border border-zinc-900 bg-zinc-950 p-2 rounded-lg text-xs font-mono max-w-xl">
              <span class="px-2 py-0.5 rounded bg-green-500/10 text-green-400 font-bold">GET</span>
            ...
            <div class="space-y-2 pt-4">
              ...
              <table class="w-full text-xs border-collapse border border-zinc-900 text-left font-normal font-sans">
                ...
                <tbody>
                  ...
                  <tr class="border-b border-zinc-900"><td class="p-2 border-r border-zinc-900 font-mono text-zinc-300">enrollmentType</td><td class="p-2 border-r border-zinc-900 text-zinc-400">enum</td><td class="p-2 border-r border-zinc-900 text-zinc-500">No</td><td class="p-2 text-zinc-400">'oneTime' | 'Subscription' | 'free' (Default: 'oneTime')</td></tr>
                  <tr class="border-b border-zinc-900"><td class="p-2 border-r border-zinc-900 font-mono text-zinc-300">status</td><td class="p-2 border-r border-zinc-900 text-zinc-400">number</td><td class="p-2 border-r border-zinc-900 text-zinc-500">No</td><td class="p-2 text-zinc-400">Enrollment status (Default: 0).</td></tr>
                  <tr class="border-b border-zinc-900"><td class="p-2 border-r border-zinc-900 font-mono text-zinc-300">amountPaid</td><td class="p-2 border-r border-zinc-900 text-zinc-400">number</td><td class="p-2 border-r border-zinc-900 text-zinc-500">No</td><td class="p-2 text-zinc-400">Initial amount paid (Default: 0).</td></tr>
                  <tr class="border-b border-zinc-900"><td class="p-2 border-r border-zinc-900 font-mono text-zinc-300">paymentStatus</td><td class="p-2 border-r border-zinc-900 text-zinc-400">enum</td><td class="p-2 border-r border-zinc-900 text-zinc-500">No</td><td class="p-2 text-zinc-400">'captured' | 'failed' | 'created' | 'refunded' (Default: 'created')</td></tr>
                  <tr class="border-b border-zinc-900"><td class="p-2 border-r border-zinc-900 font-mono text-zinc-300">paymentMethod</td><td class="p-2 border-r border-zinc-900 text-zinc-400">string</td><td class="p-2 border-r border-zinc-900 text-zinc-500">No</td><td class="p-2 text-zinc-400">Payment method used.</td></tr>
                  <tr class="border-b border-zinc-900"><td class="p-2 border-r border-zinc-900 font-mono text-zinc-300">transactionId</td><td class="p-2 border-r border-zinc-900 text-zinc-400">string</td><td class="p-2 border-r border-zinc-900 text-zinc-500">No</td><td class="p-2 text-zinc-400">Transaction ID reference. Must be unique.</td></tr>
                  <tr class="border-b border-zinc-900"><td class="p-2 border-r border-zinc-900 font-mono text-zinc-300">invoiceId</td><td class="p-2 border-r border-zinc-900 text-zinc-400">string</td><td class="p-2 border-r border-zinc-900 text-zinc-500">No</td><td class="p-2 text-zinc-400">Invoice ID reference. Must be unique.</td></tr>
                  <tr class="border-b border-zinc-900"><td class="p-2 border-r border-zinc-900 font-mono text-zinc-300">paidAt</td><td class="p-2 border-r border-zinc-900 text-zinc-400">string</td><td class="p-2 border-r border-zinc-900 text-zinc-500">No</td><td class="p-2 text-zinc-400">ISO payment date.</td></tr>
                  <tr class="border-b border-zinc-900"><td class="p-2 border-r border-zinc-900 font-mono text-zinc-300">accessTill</td><td class="p-2 border-r border-zinc-900 text-zinc-400">string (YYYY-MM-DD)</td><td class="p-2 border-r border-zinc-900 text-zinc-500">No</td><td class="p-2 text-zinc-400">Access end date.</td></tr>
                  <tr class="border-b border-zinc-900"><td class="p-2 border-r border-zinc-900 font-mono text-zinc-300">overrideAccessDays</td><td class="p-2 border-r border-zinc-900 text-zinc-400">number</td><td class="p-2 border-r border-zinc-900 text-zinc-500">No</td><td class="p-2 text-zinc-400">Override days of course access.</td></tr>
                  <tr class="border-b border-zinc-900"><td class="p-2 border-r border-zinc-900 font-mono text-zinc-300">remark</td><td class="p-2 border-r border-zinc-900 text-zinc-400">string</td><td class="p-2 border-r border-zinc-900 text-zinc-500">No</td><td class="p-2 text-zinc-400">Internal remark.</td></tr>
                  <tr class="border-b border-zinc-900"><td class="p-2 border-r border-zinc-900 font-mono text-zinc-300">sequentialLearning</td><td class="p-2 border-r border-zinc-900 text-zinc-400">boolean</td><td class="p-2 border-r border-zinc-900 text-zinc-500">No</td><td class="p-2 text-zinc-400"><span class="px-1.5 py-0.5 rounded bg-emerald-500/10 text-emerald-400 text-[9px] font-semibold uppercase tracking-wider font-mono">Updated</span> Restrict progress sequentially based on previous video.</td></tr>
                  <tr class="border-b border-zinc-900"><td class="p-2 border-r border-zinc-900 font-mono text-zinc-300">sequentialLearningWithAssignments</td><td class="p-2 border-r border-zinc-900 text-zinc-400">boolean</td><td class="p-2 border-r border-zinc-900 text-zinc-500">No</td><td class="p-2 text-zinc-400"><span class="px-1.5 py-0.5 rounded bg-emerald-500/10 text-emerald-400 text-[9px] font-semibold uppercase tracking-wider font-mono">Updated</span> Restrict progress sequentially including assignments.</td></tr>
                </tbody>
              </table>
            </div>
          </div>
      ...
      "trend": [
        {
          ...
          "totalCollected": 1000,
          "paymentCount": 5,
          "amountWithoutGst": 847.46
        },
        {
          "bucket": "2026-07-25",
          "totalCollected": 3999,
          "paymentCount": 10,
          "amountWithoutGst": 3388.98
        }
      ]
    },
    "transactions": [
  ...
  "data": {
    ...
    "chartData": [
      { "date": "2026-07-11", "usersCount": 10, "timeSpentSeconds": 9000, "viewsCount": 38 }
        ...
        <!-- Endpoint: GET /v1/admin/course-progress/enrollments/:enrollmentId -->
        <div id="user-batch-progress" class="scroll-mt-24 grid grid-cols-1 xl:grid-cols-5 gap-8">
          <div class="xl:col-span-3 space-y-4">
            <div class="text-xs text-indigo-400 font-mono tracking-wider font-semibold uppercase">Course Progress</div>
            <h3 class="text-2xl font-semibold text-zinc-100">Enrollment Batch Progress</h3>
            <p class="text-zinc-400 text-sm leading-relaxed">
              Retrieves the complete list of sections, chapters, content items, and study progress for a specific enrollment. Requires Admin Role.
            </p>
            <div class="flex items-center gap-2 border border-zinc-900 bg-zinc-950 p-2 rounded-lg text-xs font-mono max-w-xl">
              <span class="px-2 py-0.5 rounded bg-green-500/10 text-green-400 font-bold">GET</span>
              <span class="text-zinc-200">/v1/admin/course-progress/enrollments/:enrollmentId</span>
            </div>
    ...
    "assignments": [
      {
        ...
        "deployedLink": "https://demo.vercel.app",
        "assignmentStatus": "submitted",
        "userRemark": "Completed all CSS core components.",
        "teacherRemark": null,
        "videoFeedback": null,
        "codeSubmitted": "CSS code payload...",
